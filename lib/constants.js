...
export const METRICS = [
  ...
  { key: 'capacity', label: 'Production Capacity', format: 'number' },
  { key: 'utilization', label: 'Utilization Rate', format: 'percent' },
...
export const METRIC_INFO = {
  ...
  capacity:          { label: 'Production Capacity',unit: 'number',   yLabel: 'Units' },
  utilization:       { label: 'Utilization Rate',   unit: 'percent',  yLabel: 'Utilization (%)' }
};
...
export const COMPANY_COLORS = [
  '#dc2626', '#eab308', '#171717'
];

export const DEFAULT_COMPANY = {
  name: 'Company 1',
  revenue: 1000, cogs: 800, rd: 150, sga: 100,
  cogsFix: 30, rdFix: 80, sgaFix: 50, deliveries: 50000, capacity: 100000
};
